...
main(int argc, char* argv[])
{
  ...
  //   // register_streamer(s, stmr2, "/register");
  ...
  //   while (true)
  //   {
  //     cv::Mat image1, image2 = random_image(), image3 = random_image();
  //     cap.read(image1);
  ...
  //     boost::this_thread::sleep(boost::posix_time::milliseconds(10)); //10 fps for ease on my eyes
  //   }
